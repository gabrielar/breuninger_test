...
class EndpointWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<EndpointBlock>(
      create: (BuildContext context) => endpointBlock,
      child: BlocBuilder<EndpointBlock, EndpointState>(
            ...
            child: SelectorList<GitHubGistEndpoints>(
              items: [
                SelectorItem(
                  ...
                  selected:
                      endpointBlock.state.endpoint ==
                      GitHubGistEndpoints.simple,
                ),
                SelectorItem(
