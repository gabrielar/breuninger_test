...
class MockRestServiceMissingUrlTeaser extends RestService {
  @override
  Future<String> get({required String urlString}) async {
    switch (urlString) {
      case "https://gist.githubusercontent.com/breunibes/bd5b65cf638fc3f67b1007721ac05205/raw/e7f9a4798d446728ba396b869af6b609a562ea03/gistfile1.txt":
...
class MockRestServiceMissingUrlSlider extends RestService {
  @override
  Future<String> get({required String urlString}) async {
    switch (urlString) {
      case "https://gist.githubusercontent.com/breunibes/bd5b65cf638fc3f67b1007721ac05205/raw/e7f9a4798d446728ba396b869af6b609a562ea03/gistfile1.txt":
...
class MockRestServiceMissingUrlBandSlider extends RestService {
  @override
  Future<String> get({required String urlString}) async {
    switch (urlString) {
      case "https://gist.githubusercontent.com/breunibes/bd5b65cf638fc3f67b1007721ac05205/raw/e7f9a4798d446728ba396b869af6b609a562ea03/gistfile1.txt":
